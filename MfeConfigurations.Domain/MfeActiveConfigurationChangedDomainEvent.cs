...
namespace MfeConfigurations.Domain
{
    public sealed class MfeActiveConfigurationChangedDomainEvent : DomainEvent
    {
        ...
        public MfeActiveConfigurationChangedDomainEvent(string id, string previousConfiguration, string activeConfiguration, string? eventId = null, string? occurredOn = null) : base(id, eventId, occurredOn)
        {
        ...
        {
            return new MfeActiveConfigurationChangedDomainEvent(aggregateId, body[nameof(this.PreviousConfiguration)], body[nameof(this.ActiveConfiguration)], eventId, occurredOn);
        }
        ...
        {
            return HashCode.Combine(this.AggregateId, this.PreviousConfiguration, this.ActiveConfiguration);
        }
    }
}
