...
namespace mfe_versions.api.V1.MfeClusterConfigurations
{
    ...
    public class ClusterConfigurationsPostController : ApiBaseController
    {
        private readonly TenantConfigurationCreator configurationCreator; //= new();

        public ClusterConfigurationsPostController(TenantConfigurationCreator configurationCreator)
        {
